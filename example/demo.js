...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('MapControls available:', typeof MapControls);
  console.log('MapControls structure:', MapControls);
  
  // Create map controls instance
  const MapControlsClass = MapControls.MapControls;
  console.log('MapControls class:', MapControlsClass);
  
  const mapControls = new MapControlsClass({
